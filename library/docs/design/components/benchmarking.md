...
- **`physicalai-train`** (training) — Benchmark presets (Libero, PushT), torch↔numpy adapters, and the existing rollout engine
...
- [Packaging Strategy](../deployment/physical-ai-two-repo-options.md) — Two-distribution PEP 420 namespace split
