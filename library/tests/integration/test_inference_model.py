...
def _skip_if_pi0_unavailable():
    ...
    try:
        ...
        if not check.check_whether_transformers_replace_is_installed_correctly():
            pytest.skip("PI0 requires patched Transformers")
    except Exception:
        pytest.skip("PI0 requires patched Transformers")
...
class TestInferenceModelACT:
    @pytest.mark.slow
    def test_load_and_run(self, tmp_path: Path):
    ...
    @pytest.mark.slow
    def test_select_action_returns_chunk_sequentially(self, tmp_path: Path):
        from physicalai.inference import InferenceModel
    ...
    @pytest.mark.slow
    def test_openvino_backend(self, tmp_path: Path):
    ...
    @pytest.mark.slow
    def test_onnx_openvino_parity(self, tmp_path: Path):
        pytest.importorskip("openvino")
        from physicalai.inference import InferenceModel
...
class TestInferenceModelManifestCompat:
    @pytest.mark.slow
    def test_manifest_fields_loaded(self, tmp_path: Path):
        from physicalai.inference import InferenceModel
